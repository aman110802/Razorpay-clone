...
This is a clone website for Razorpay, a popular online payment platform in India. The website is built using HTML and Tailwind CSS, a utility-first CSS framework that makes it easy to style and layout web pages.
...
- Clone the repository to your local machine: git clone https://github.com/aman110802/Razorpay-clone
